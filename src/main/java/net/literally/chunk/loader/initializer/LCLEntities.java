...
public final class LCLEntities
{
    ...
    {
        CHUNK_LOADER_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, LCLLoader.MOD_ID + ":" + ChunkLoaderBlock.ID.getPath(), FabricBlockEntityTypeBuilder.create(ChunkLoaderBlockEntity::new, LCLBlocks.CHUNK_LOADER_BLOCK).build(null));
    }
}
